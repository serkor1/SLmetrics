...
The `fer.factor()` method calls `cmatrix()` internally, so explicitly
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>fer.factor</code>,
<code>weighted.fer.factor</code>, <code>fer.cmatrix</code></p>
<dl>
...
`cross.entropy()`, `dor()`, `fbeta()`, `fdr()`, `fmi()`, `fpr()`,
