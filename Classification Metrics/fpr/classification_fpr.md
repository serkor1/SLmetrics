...
A generic S3 function to compute the *false positive rate* score for a
classification model. This function dispatches to S3 methods in `fpr()`
...
Because `fpr()` operates on raw pointers, pointer‑level faults (e.g.
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>fpr.factor</code>,
<code>weighted.fpr.factor</code>, <code>fpr.cmatrix</code></p>
<dl>
...
`fer()`, `fmi()`, `hammingloss()`, `huberloss()`, `jaccard()`,
