...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>baccuracy.factor</code>,
<code>weighted.baccuracy.factor</code>,
<code>baccuracy.cmatrix</code></p>
<dl>
<dt><code>adjust</code></dt>
<dd>
<p>A &lt;logical&gt; value (default: FALSE). If TRUE the metric is
adjusted for random chance <code class="reqn">\frac{1}{k}</code>.</p>
</dd>
...
`auc.roc.curve()`, `brier.score()`, `ccc()`, `ckappa()`, `cmatrix()`,
