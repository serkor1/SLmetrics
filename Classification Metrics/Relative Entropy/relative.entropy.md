...
A generic S3 function to compute the *relative entropy* score for a
classification model. This function dispatches to S3 methods in
`relative.entropy()` and performs no input validation. If you supply NA
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>relative.entropy.matrix</code></p>
<dl>
<dt><code>pk,qk</code></dt>
<dd>
<p>A pair of &lt;double&gt; matrices of length <code
...
`recall()`, `rmse()`, `rmsle()`, `roc.curve()`, `rrmse()`, `rrse()`,
`rsq()`, `shannon.entropy()`, `smape()`, `specificity()`,
`zerooneloss()`
