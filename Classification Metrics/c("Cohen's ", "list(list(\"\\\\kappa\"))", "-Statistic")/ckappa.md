...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>ckappa.factor</code>,
<code>weighted.ckappa.factor</code>, <code>ckappa.cmatrix</code></p>
<dl>
<dt><code>beta</code></dt>
<dd>
<p>A &lt;double&gt; value of length 1 (default: 0). If <code
class="reqn">\beta \neq 0</code> the off-diagonals of the confusion
matrix are penalized with a factor of <code
class="reqn">(y_{+} - y_{i,-})^\beta</code>.</p>
</dd>
...
`baccuracy()`, `brier.score()`, `cmatrix()`, `cross.entropy()`, `dor()`,
...
`auc.roc.curve()`, `baccuracy()`, `brier.score()`, `ccc()`, `cmatrix()`,
