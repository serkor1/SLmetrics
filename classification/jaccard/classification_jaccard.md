...
`jaccard()` and performs no input validation. If you supply NA values or
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>jaccard.factor</code>,
<code>weighted.jaccard.factor</code>, <code>jaccard.cmatrix</code></p>
<dl>
...
`fpr()`, `hammingloss()`, `logloss()`, `mcc()`, `nlr()`, `npv()`,
...
`fer()`, `fmi()`, `fpr()`, `hammingloss()`, `huberloss()`, `logloss()`,
