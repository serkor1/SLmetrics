...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>rsq.numeric</code>,
<code>weighted.rsq.numeric</code></p>
<dl>
...
<dt><code>k</code></dt>
<dd>
<p>A &lt;double&gt;-vector of length 1 (default: 0). For adjusted <code
class="reqn">R^2</code> set <code class="reqn">k = \kappa - 1</code>,
where <code class="reqn">\kappa</code> is the number of parameters.</p>
</dd>
<dt><code>w</code></dt>
<dd>
...
`rrmse()`, `rrse()`, `shannon.entropy()`, `smape()`, `specificity()`,
`zerooneloss()`
