...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>rrse.numeric</code>,
<code>weighted.rrse.numeric</code></p>
<dl>
...
`mse()`, `pinball()`, `rae()`, `rmse()`, `rmsle()`, `rrmse()`, `rsq()`,
`smape()`
...
`rrmse()`, `rsq()`, `shannon.entropy()`, `smape()`, `specificity()`,
`zerooneloss()`
