...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>rmsle.numeric</code>,
<code>weighted.rmsle.numeric</code></p>
<dl>
...
`mse()`, `pinball()`, `rae()`, `rmse()`, `rrmse()`, `rrse()`, `rsq()`,
`smape()`
...
`recall()`, `relative.entropy()`, `rmse()`, `roc.curve()`, `rrmse()`,
