...
|                |                 |
|----------------|----------------:|
| deviance.gamma | R Documentation |
...
`deviance.gamma()` and performs no input validation. If you supply NA
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>deviance.gamma.numeric</code>,
<code>weighted.deviance.gamma.numeric</code></p>
<dl>
...
Other Regression: `ccc()`, `deviance.poisson()`, `deviance.tweedie()`,
...
`cmatrix()`, `cross.entropy()`, `deviance.poisson()`,
