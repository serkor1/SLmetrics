...
`gmse()` and performs no input validation. If you supply NA values or
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>gmse.numeric</code>,
<code>weighted.gmse.numeric</code></p>
<dl>
