...
Because `rmse()` operates on raw pointers, pointer‑level faults (e.g.
...
To guard against this, wrap `rmse()` in a “safe” validator that checks
...
<tr class="odd">
<td><code id="...">...</code></td>
<td><p>Arguments passed on to <code>rmse.numeric</code>,
<code>weighted.rmse.numeric</code></p>
<dl>
...
`mse()`, `pinball()`, `rae()`, `rmsle()`, `rrmse()`, `rrse()`, `rsq()`,
`smape()`
...
`recall()`, `relative.entropy()`, `rmsle()`, `roc.curve()`, `rrmse()`,
