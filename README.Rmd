...
To illustrate the impact of OpenMP on performance, consider the following benchmarks for calculating entropy on a 1,000,000 x 200 matrix over 100 iterations[^1].

### :books: Entropy without OpenMP

```{r Without OpenMP, echo = FALSE}
# 1) extract data;
