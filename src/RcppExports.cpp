...
// weighted_mse
double weighted_mse(const NumericVector& actual, const NumericVector& predicted, const NumericVector& w);
...
// weighted_rmsle
double weighted_rmsle(const NumericVector& actual, const NumericVector& predicted, const NumericVector& w);
