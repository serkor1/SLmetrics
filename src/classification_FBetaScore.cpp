...
NumericVector fbeta(const IntegerVector& actual, const IntegerVector& predicted, const double& beta = 1.0, Nullable<bool> micro = R_NilValue, const bool& na_rm = true) {
    FBetaScoreMetric foo(beta); // Instantiate F-Beta metric with the provided beta value
...
NumericVector weighted_fbeta(const IntegerVector& actual, const IntegerVector& predicted, const NumericVector& w, const double& beta = 1.0, Nullable<bool> micro = R_NilValue, const bool& na_rm = true) {
    FBetaScoreMetric foo(beta); // Instantiate F-Beta metric with the provided beta value
